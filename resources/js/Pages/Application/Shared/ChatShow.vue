<template>
    <section-content class="mt-8">
        ...
        <template #description>
            Hier sieht du alle Daten der Nachricht
        </template>
        <template #content>
                                        ...
                                        >
                                            ...
                                            <td class="np-dl-td-normal">
                                                ...
                                                <div class="hidden">
                                                    ...
                                                    <br />
                                                    chat.receiver_person_company_id:
                                                    {{
                                                        chat.receiver_person_company_id
                                                    }}
                                                    <br />
                                            ...
                                            <td class="np-dl-td-normal">
                                                <div
                                                    v-if="
                                                        singlechat.read_status
                                                    "
                                                >
                                                    gelesen am
                                                    <display-date
                                                        :value="
                                                            singlechat.read_date
                                                        "
                                                        :time-on="true"
                                                    />
                                                </div>
