        ...
        <template v-if="Object.keys(invitations).length > 0">
            <section-content class="mb-6" :full-width="true">
                ...
                <template #description>
                    Hier kannst du die Liste aller eingeladenen Teammitglieder
                    einsehen.
                    <!-- Loading -->
                    <input-loading
                        :loading="loading"
...
export default defineComponent({
    ...
    methods: {
        deleteInvitation(id) {
            ...
            //
            this.$inertia.delete(this.route("employee.invitation.delete", id), {
                onSuccess: () => {
                    this.loading = false;
                },
                onError: () => {
