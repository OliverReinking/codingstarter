    ...
    <admin-layout>
        <template #breadcrumb>
            <breadcrumb
                ...
                :current="
                    webinar.id > 0 ? 'Ändere Webinar' : 'Webinar erstellen'
                "
                :breadcrumbs="{
                ...
                <input-group>
                    ...
                    <input-container :full-width="true">
                        <input-checkbox name="active" v-model="form.active">
                            Soll das Webinar auf der Homepage verfügbar
                            sein?</input-checkbox
                        >
                    </input-container>
                </input-group>
            ...
            <template #actions>
                ...
                <button-group>
                    ...
                    >
                        <input-button
                            type="button"
                            @click.prevent="updateWebinarData"
                        >
                            Webinar ändern
                        </input-button>
                    </smooth-scroll>
                    ...
                    >
                        <input-button
                            type="button"
                            @click.prevent="createWebinarData"
                        >
                            Webinar erstellen
                        </input-button>
                    </smooth-scroll>
                    ...
                    >
                        ...
                        <tippy
                            >Diese Funktion funktioniert nur am
                            Veranstaltungstag</tippy
                        >
                    </smooth-scroll>
                </button-group>
                <!-- ENDS Befehle -->
        ...
        >
            ...
            <template #description>
                Hier kannst du die Liste der Anmeldungen für dieses Webinar
                einsehen.
            </template>
            <template #content>
                <div class="np-dl-outer-container">
                    <div class="np-dl-data-container">
                        ...
                        <alert
                            ...
                            v-if="Object.keys(webinar_orders).length == 0"
                        >
                            Zur Zeit liegen für dieses Webinar keine Anmeldungen
                            vor.
                        </alert>
                    </div>
                </div>
        ...
        >
            ...
            <template #content>
                Bist du sicher, dass du dieses Webinar und alle
                Webinaranmeldungen löschen willst?
            </template>
...
export default defineComponent({
    ...
    methods: {
        ...
        sendReminderToParticipants() {
            ...
            //
            this.$inertia.put(
                this.route("admin.webinar.reminder", this.webinar.id),
                {
                    onSuccess: () => {
                        this.loading = false;
                    },
