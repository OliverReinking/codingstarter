...
export default defineComponent({
  ...
  methods: {
    filterChats(filter_read) {
      ...
      //
      this.$inertia.get(this.route("admin.chat.inbox.index", { filter_read, page: 1 }), {
        onSuccess: () => {
          this.loading = false;
        },
        onError: () => {
