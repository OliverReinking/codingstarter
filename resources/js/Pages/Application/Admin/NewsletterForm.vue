    ...
    <admin-layout>
            ...
            <template #actions>
                ...
                <button-group>
                    ...
                    <smooth-scroll href="#app-layout-start">
                        <input-button
                            type="button"
                            @click.prevent="updateNewsletterData"
                        >
                            Newsletter ändern
                        </input-button>
                    </smooth-scroll>
        ...
        <template v-if="newsletter_members">
            ...
            <section-content :full-width="true">
                ...
                <template #description>
                    Hier kannst du die Liste der Abonnenten für diesen
                    Newsletter einsehen.
                    <!-- Loading -->
                    <input-loading
                        :loading="loadingTwo"
                            ...
                            <table class="np-dl-table">
                                <thead class="np-dl-thead">
                                    <tr>
                                        ...
                                        <th class="np-dl-th-normal">
                                            per Mail verifiziert?
                                        </th>
        ...
        >
            ...
            <template #content>
                Bist du sicher, dass du diesen Newsletter und all seine
                Abonennten löschen willst?
            </template>
...
export default defineComponent({
    ...
    methods: {
        ...
        deleteNewsletterMember(id) {
            ...
            //
            this.$inertia.delete(
                this.route("admin.newsletter.member.delete", id),
                {
                    onSuccess: () => {
